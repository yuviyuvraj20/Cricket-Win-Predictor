            ...
            <br><br><br><br>
                            <div class="container">
                                ...
                                <%
                                    ...
                                    ResultSet resultSet = statement.executeQuery("SELECT opposition, count(case when result = 'won' then 1 else null end  ) as res  FROM indiadata GROUP BY opposition order by res desc ");
